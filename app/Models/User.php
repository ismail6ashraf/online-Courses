...
class User extends Authenticatable
{
    ...
    public function classSessionsAsInstructor()
    {
        return $this->hasMany(ClassSession::class, 'instructor_id');
    }
    public function tasks()
    {
        return $this->hasMany(InstructorTask::class, 'instructor_id');
    }
    public function alerts()
    {
        return $this->hasMany(Alert::class, 'target_user_id');
    }
    public function speechLogs()
    {
        return $this->hasMany(SpeechLog::class, 'speaker_id');
    }
    public function behaviorIncidents()
    {
        return $this->hasMany(BehaviorIncident::class);
    }
    public function dataLeakageIncidents()
    {
        return $this->hasMany(DataLeakageIncident::class);
    }
    ...
    public function hasActiveSubscription()
    {
        ...
        return $this->subscription->status === 'active'
            && now()->lessThanOrEqualTo($this->subscription->end_date);
    }
}
